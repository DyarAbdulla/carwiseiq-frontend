...
function CarPreviewImage({
  ...
  useEffect(() => {
    ...
    setHasError(false)
    console.log('[CarPreviewImage] previewImageSrc:', previewImageSrc)
  }, [previewImageSrc])
...
export default function PredictPage() {
  ...
  return (
    <main className="relative min-h-screen bg-gradient-to-b from-slate-950 via-slate-950 to-slate-900">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-10 overflow-visible">
        {/* Header with cinematic hero background */}
        <motion.div
          ref={heroRef}
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
          className="relative mb-8 md:mb-12 text-center py-16 md:py-20 lg:py-24 rounded-3xl overflow-hidden"
          role="img"
          aria-label="Hero background"
        >
          {/* Cinematic Background Car Image (car-hero-5) with Parallax */}
          <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
            <div
              className="absolute inset-0"
              style={{
                transform: `translate(${mousePosition.x}px, ${mousePosition.y + scrollY * 0.3}px) scale(1.1)`,
          ...
          <div
            aria-hidden="true"
            className="absolute -inset-4 -z-10 rounded-[32px] blur-3xl opacity-40"
            style={{
              background: "radial-gradient(circle at 50% 50%, rgba(99,102,241,0.15), transparent 70%)",
            }}
          />

          {/* Premium Glass Card Content - Sharp and Prominent */}
          <div className="relative z-10 mx-auto max-w-4xl px-4 sm:px-6">
            <motion.div
              initial={{ opacity: 0, scale: 0.95 }}
              animate={{ opacity: 1, scale: 1 }}
              transition={{ duration: 0.6, delay: 0.2 }}
              className="glassBorder rounded-3xl"
              style={{
                filter: 'none', // Ensure no blur on the card itself
              }}
            >
              <div
                className="glassCard rounded-3xl px-6 py-8 sm:px-8 sm:py-10 md:px-10 md:py-12"
                style={{
                  backdropFilter: 'blur(32px)',
                  WebkitBackdropFilter: 'blur(32px)',
                  filter: 'none', // Keep card sharp
                }}
              >
                <motion.h1
                  ...
                  className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold mb-4 text-white drop-shadow-2xl tracking-tight"
                ...
                <motion.p
                  ...
                  className="text-lg sm:text-xl md:text-2xl text-white/95 max-w-3xl mx-auto drop-shadow-lg font-light leading-relaxed"
        ...
        <div className={`grid gap-6 ${prediction ? 'grid-cols-1 lg:grid-cols-2' : 'grid-cols-1'}`}>
          ...
          >
            <Card className="border border-white/10 bg-white/[0.03] backdrop-blur-xl hover:bg-white/[0.05] hover:border-white/20 transition-all duration-300 group overflow-visible">
              <CardHeader>
              ...
              <CardContent className="overflow-visible relative z-10">
                ...
                {/* Car Image Preview */}
                <AnimatePresence>
                  {formFeatures && formFeatures.make && formFeatures.model && (
                    <motion.div
                    ...
                    >
                      <CarImagePreview
                        make={formFeatures.make}
                        model={formFeatures.model}
                        year={formFeatures.year || 2020}
                      />
                    </motion.div>
                  )}
                </AnimatePresence>
              ...
              >
                ...
                <AnimatePresence>
                  {loading && (
                    ...
                    >
                      <Card className="border border-white/10 bg-white/[0.03] backdrop-blur-xl shadow-xl">
                    ...
                    >
                        ...
                        <Card className="border border-white/10 bg-white/[0.03] backdrop-blur-xl">
                          ...
                          <CardContent className="space-y-4">
                            {/* Image display - 16:9 aspect ratio - Single render path */}
                            <ErrorBoundary fallback={
